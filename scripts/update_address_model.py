...
MAX_EPOCHS = 5
DROP_OUT = 0.2
BATCH_SIZE = 16  # menor para estabilidade
USE_GPU = True
...
def load_dev_examples(spacy_file, nlp_model):
    ...
    for ref_doc in doc_bin.get_docs(nlp_model.vocab):
        ...
        example = Example(pred_doc, ref_doc)  # referência = dev set
